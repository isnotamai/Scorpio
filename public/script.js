(function() {
  ...
  document.getElementById('btn-logout').addEventListener('click', async () => {
    ...
    if (dashPanel.classList.contains('is-open')) {
  ...
  async function loadDashboard() {
    ...
    try {
      ...
      const quotaBarText = isUnlimited ? data.quota.used + '/\u221E' : data.quota.used + '/' + data.quota.max;
      document.getElementById('auth-quota').textContent = quotaBarText;
